...
function BotMessage(props) {
  ...
  return (
    <div
      className={`transition-all duration-150 ease-out w-11/12 flex flex-row text-white ${scale}`}
    >
      <div className="bg-teal-500 m-3 rounded-t-2xl rounded-br-2xl p-4 shadow-md break-words outline-dotted outline-1 outline-gray-500">
